...
choco upgrade ruby -y --no-progress
choco upgrade msys2 -y --no-progress
choco upgrade nodejs-lts -y --no-progress
choco upgrade nugetpackageexplorer -y --no-progress
choco upgrade rdcman -y --no-progress
choco upgrade docker-cli -y --no-progress
choco upgrade dotnet-6.0-sdk -y --no-progress
choco upgrade dotnet-6.0-windowshosting -y --no-progress
...
choco upgrade wsus-offline-update -y --no-progress
choco upgrade git -y --no-progress
choco upgrade putty -y --no-progress
choco upgrade p4merge -y --no-progress
# choco upgrade tortoisegit -y
# choco upgrade sourcetree -y
choco upgrade python -y --no-progress
choco upgrade 7zip -y --no-progress
choco upgrade powershell-core -y --no-progress
choco upgrade Firefox-Dev --pre -y --no-progress
